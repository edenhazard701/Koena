                ...
                <div class="card">
                  <div class="row" style="padding:30px">
                      <div class="col-12" style="display:flex">
                        <div class="col-2" onclick="$('#upload-ava').click();">
                          <img
                          alt="image"
                          width="100px"
                          height="auto"
            ...
            <div class="modal-body" id="openJournal_detail">
                <form method="post" id="accountDetailsModalInsertUpdate1">
                    ...
                    <div class="container mt-4 my-4">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-purple mr-3" data-dismiss="modal">Close</button>
                            <input type="submit" id="submitaccount" value="Save" class="btn btn-primary" name="submits1">
                        </div>
    ...
    <img alt="image" src="<?php echo $_SESSION['avatar']?$_SESSION['avatar']:base_url('assets/img/avatar/avatar-1.png')?>" class="rounded-circle mr-1">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <?php } ?>
              ...
              <li class="nav-side-bar" data-selection="account"><a class="nav-link" href="<?php echo base_url('summary/account') ?>"><i class="fas fa-bars"></i> <span>Account Summary
              </span></a></li>
              <li class="nav-side-bar" data-selection="journal"><a class="nav-link" href="<?php echo base_url('summary/journal') ?>"><i class="fas fa-th"></i> <span>Journal Summary
              </span></a></li>
       ...
       <script>
          ...
          $('#cur_url').val(window.location.href);
        </script>
      </div>
      <!-- Main Content -->
